...
/* ParamList apiparam1 = new ParamList();
    ...
    ApiListEntity parameters1 = new ApiListEntity();
    ...
    ApiListEntity parameters2 = new ApiListEntity();
    ...
    ApiListEntity parameters3 = new ApiListEntity();
    ...
    ApiListEntity parameters4 = new ApiListEntity();
    ...
    ApiListEntity parameters5 = new ApiListEntity();
    ...
    List<ApiListEntity> parameters = new ArrayList<>();
